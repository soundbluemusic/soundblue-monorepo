...
export const i18nKoToEnSentences: Record<string, string> = {
  ...
  '뮤지션을 위한 무료 도구. 가입 없이. 추적 없이. 바로 사용':
    'Free tools for musicians. No signup. No tracking. Just use',
  ...
  '도구 검색': 'Search tools',
  검색: 'Search',
  '도구 및 페이지 검색': 'Search tools and pages',
  '웹 표준 기반 UI/UX': 'UI/UX based on web standards',
  'XML 사이트맵 (검색 엔진용)': 'XML Sitemap (for search engines)',
};

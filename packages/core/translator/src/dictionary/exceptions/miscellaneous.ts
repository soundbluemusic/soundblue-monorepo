...
export const ABBREVIATIONS: MiscException[] = [
  ...
  { korean: '고대', english: 'Korea University', type: 'abbreviation', reason: '고려대학교 약어' },
  {
    ...
    english: 'KAIST',
    type: 'abbreviation',
    reason: 'Korea Advanced Institute of Science and Technology',
  },
  {
    korean: '포스텍',
    english: 'POSTECH',
    type: 'abbreviation',
    reason: 'Pohang University of Science and Technology',
  },
  ...
  {
    korean: 'CFO',
    english: 'Chief Financial Officer',
    type: 'abbreviation',
    reason: '최고재무책임자',
  },
...
export const SLANG: MiscException[] = [
  ...
  {
    korean: '갑분싸',
    english: 'sudden awkward silence',
    type: 'slang',
    reason: '갑자기 분위기 싸해짐',
  },
...
export const SPECIAL_GRAMMAR: MiscException[] = [
  ...
  {
    korean: '(으)로',
    english: 'to/by (direction/means)',
    type: 'special-grammar',
    reason: '방향/수단 조사',
  },
  {
    korean: '와/과',
    english: 'with/and (formal)',
    type: 'special-grammar',
    reason: '연결 조사(격식)',
  },
  {
    korean: '하고',
    english: 'with/and (casual)',
    type: 'special-grammar',
    reason: '연결 조사(구어)',
  },

        ...
        <ul className="flex items-center justify-around h-full m-0 p-0 list-none">
            ...
            return (
              <li key={item.path} className="flex-1 h-full">
                <Link
                  ...
                  prefetch="intent"
                  className={`flex flex-col items-center justify-center gap-1 h-full p-2 no-underline transition-all duration-150 ease-(--ease-default) active:scale-95 focus-visible:outline-2 focus-visible:outline-(--color-border-focus) focus-visible:outline-offset-2 ${
                    isActive
          ...
          <li className="flex-1 h-full">
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 w-full h-full p-2 bg-transparent border-none cursor-pointer transition-all duration-150 ease-(--ease-default) active:scale-95 focus-visible:outline-2 focus-visible:outline-(--color-border-focus) focus-visible:outline-offset-2 ${
            ...
            return (
              <li key={item.path}>
                <button
                  ...
                  className={`flex items-center gap-4 w-full p-4 bg-transparent border-none rounded-2xl cursor-pointer transition-all duration-150 ease-(--ease-default) active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-(--color-border-focus) focus-visible:outline-offset-2 ${
                    isActive

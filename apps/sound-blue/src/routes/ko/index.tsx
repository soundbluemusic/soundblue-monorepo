...
export const Route = createFileRoute('/ko/')({
  head: () => ({
    ...
    links: [
      ...
      { rel: 'alternate', hrefLang: 'ko', href: 'https://soundbluemusic.com/ko/' },
      { rel: 'alternate', hrefLang: 'en', href: 'https://soundbluemusic.com/' },
      { rel: 'alternate', hrefLang: 'x-default', href: 'https://soundbluemusic.com/' },
    ],
  }),
  component: Home,
});
    ...
    <NavigationLayout>
      <div className="min-h-screen flex flex-col items-center justify-center p-8">
        <div className="animate-slide-up text-center max-w-2xl">
          ...
          <p className="text-base text-[var(--color-text-tertiary)] mb-8">{m['home.genres']()}</p>

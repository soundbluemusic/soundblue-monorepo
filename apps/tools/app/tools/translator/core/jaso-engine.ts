...
import { type EnToKoResult, translateEnToKo, translateEnToKoDetailed } from './en-to-ko';
import { type KoToEnResult, translateKoToEn, translateKoToEnDetailed } from './ko-to-en';

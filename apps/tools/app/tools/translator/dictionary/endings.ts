...
export const ENDINGS: EndingPattern[] = [
	...
	// 격식체
	{ jaso: ['ㅇ', 'ㅏ', 'ㅆ', 'ㅅ', 'ㅡ', 'ㅂ', 'ㄴ', 'ㅣ', 'ㄷ', 'ㅏ'], tense: 'past', formality: 'formal' }, // -았습니다
	{ jaso: ['ㅇ', 'ㅓ', 'ㅆ', 'ㅅ', 'ㅡ', 'ㅂ', 'ㄴ', 'ㅣ', 'ㄷ', 'ㅏ'], tense: 'past', formality: 'formal' }, // -었습니다
	{ jaso: ['ㅎ', 'ㅐ', 'ㅆ', 'ㅅ', 'ㅡ', 'ㅂ', 'ㄴ', 'ㅣ', 'ㄷ', 'ㅏ'], tense: 'past', formality: 'formal' }, // -했습니다
	...
	// 격식체
	{ jaso: ['ㄹ', 'ㄱ', 'ㅓ', 'ㅅ', 'ㅅ', 'ㅡ', 'ㅂ', 'ㄴ', 'ㅣ', 'ㄷ', 'ㅏ'], tense: 'future', formality: 'formal' }, // -ㄹ것습니다
	{ jaso: ['ㄱ', 'ㅔ', 'ㅆ', 'ㅅ', 'ㅡ', 'ㅂ', 'ㄴ', 'ㅣ', 'ㄷ', 'ㅏ'], tense: 'future', formality: 'formal' }, // -겠습니다
	...
	// 진행형 (10개)
	// ========================================
	{ jaso: ['ㄱ', 'ㅗ', 'ㅇ', 'ㅣ', 'ㅆ', 'ㅅ', 'ㅡ', 'ㅂ', 'ㄴ', 'ㅣ', 'ㄷ', 'ㅏ'], tense: 'progressive', formality: 'formal' }, // -고있습니다
	{ jaso: ['ㄱ', 'ㅗ', 'ㅇ', 'ㅣ', 'ㅆ', 'ㅇ', 'ㅓ', 'ㅇ', 'ㅛ'], tense: 'progressive', formality: 'polite' }, // -고있어요
	...
	{ jaso: ['ㄴ', 'ㅡ', 'ㄴ', 'ㅈ', 'ㅜ', 'ㅇ', 'ㅣ', 'ㅇ', 'ㅓ', 'ㅇ', 'ㅛ'], tense: 'progressive', formality: 'polite' }, // -는중이어요
	...
	{ jaso: ['ㅈ', 'ㅣ', 'ㅇ', 'ㅏ', 'ㄴ', 'ㅎ', 'ㅏ', 'ㅇ', 'ㅛ'], negative: true, formality: 'polite' }, // -지않아요
	{ jaso: ['ㅈ', 'ㅣ', 'ㅇ', 'ㅏ', 'ㄴ', 'ㅎ', 'ㅏ', 'ㅆ', 'ㄷ', 'ㅏ'], negative: true, tense: 'past' }, // -지않았다
	{ jaso: ['ㅈ', 'ㅣ', 'ㅁ', 'ㅗ', 'ㅅ', 'ㅎ', 'ㅏ', 'ㄷ', 'ㅏ'], negative: true }, // -지못하다
	{ jaso: ['ㅈ', 'ㅣ', 'ㅁ', 'ㅗ', 'ㅅ', 'ㅎ', 'ㅐ'], negative: true }, // -지못해
	{ jaso: ['ㅈ', 'ㅣ', 'ㅁ', 'ㅗ', 'ㅅ', 'ㅎ', 'ㅏ', 'ㅇ', 'ㅛ'], negative: true, formality: 'polite' }, // -지못해요

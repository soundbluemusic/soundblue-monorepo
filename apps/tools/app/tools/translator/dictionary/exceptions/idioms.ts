...
export const KOREAN_IDIOMS: IdiomEntry[] = [
  ...
  // 추가 관용구 - 일상/상황
  { phrase: '발등에 불이 떨어지다', translation: 'urgent situation', category: '상황' },
  { phrase: '발목을 잡히다', translation: 'be hindered', category: '상황' },
  { phrase: '손을 떼다', translation: 'quit', category: '동작' },
  { phrase: '손을 놓다', translation: 'give up', category: '동작' },
  { phrase: '손을 대다', translation: 'start working on', category: '동작' },
  { phrase: '손을 쓰다', translation: 'take action', category: '동작' },
  { phrase: '손이 많이 가다', translation: 'labor-intensive', category: '상황' },
  { phrase: '입이 짧다', translation: 'picky eater', category: '성격' },
  { phrase: '입맛을 다시다', translation: 'look forward to', category: '감정' },
  { phrase: '입에 침도 바르지 않다', translation: 'lie easily', category: '태도' },
  { phrase: '입이 열 개라도 할 말이 없다', translation: 'no excuse', category: '상황' },
  { phrase: '눈에 쌍심지를 켜다', translation: 'furious', category: '감정' },
  { phrase: '눈 밖에 나다', translation: 'lose favor', category: '관계' },
  { phrase: '눈 깜짝할 사이', translation: 'in a blink', category: '시간' },
  { phrase: '눈 감아주다', translation: 'overlook', category: '동작' },
  { phrase: '귀에 거슬리다', translation: 'annoying to hear', category: '감정' },
  { phrase: '귀를 의심하다', translation: "can't believe what I heard", category: '반응' },
  { phrase: '귀가 간지럽다', translation: 'suspect being talked about', category: '감정' },
  { phrase: '고개를 갸웃거리다', translation: 'puzzled', category: '반응' },
  { phrase: '고개를 끄덕이다', translation: 'nod in agreement', category: '동작' },
  { phrase: '고개를 젓다', translation: 'shake head (disagree)', category: '동작' },
  { phrase: '고개를 들다', translation: 'recover', category: '상황' },
  { phrase: '고개를 숙이다', translation: 'bow down', category: '동작' },
  { phrase: '어깨가 무겁다', translation: 'burdened', category: '감정' },
  { phrase: '어깨를 으쓱하다', translation: 'shrug', category: '동작' },
  { phrase: '팔을 걷다', translation: 'get ready to work', category: '동작' },
  { phrase: '팔짱을 끼다', translation: 'fold arms', category: '동작' },
  { phrase: '다리를 뻗고 자다', translation: 'sleep soundly', category: '상태' },
  { phrase: '배가 부르다', translation: 'full (food)', category: '상태' },
  { phrase: '배를 채우다', translation: 'fill stomach', category: '동작' },
  { phrase: '배꼽을 잡다', translation: 'laugh heartily', category: '동작' },
  { phrase: '목이 빠지게 기다리다', translation: 'wait eagerly', category: '감정' },
  { phrase: '목을 매다', translation: 'insist on', category: '태도' },
  { phrase: '목청을 높이다', translation: 'raise voice', category: '동작' },
  { phrase: '가슴을 치다', translation: 'regret deeply', category: '감정' },
  { phrase: '가슴을 쓸어내리다', translation: 'feel relieved', category: '감정' },
  { phrase: '가슴에 손을 얹다', translation: 'be honest with oneself', category: '태도' },
  { phrase: '마음을 먹다', translation: 'make up mind', category: '결심' },
  { phrase: '마음을 졸이다', translation: 'worry', category: '감정' },
  { phrase: '마음이 급하다', translation: 'impatient', category: '성격' },
  { phrase: '마음이 편하다', translation: 'at ease', category: '감정' },
  { phrase: '마음이 무겁다', translation: 'heavy-hearted', category: '감정' },
  { phrase: '정신을 차리다', translation: 'come to senses', category: '동작' },
  { phrase: '정신이 팔리다', translation: 'distracted', category: '상태' },
  { phrase: '정신이 없다', translation: 'hectic', category: '상태' },
  { phrase: '넋을 잃다', translation: 'stunned', category: '상태' },
  { phrase: '넋이 나가다', translation: 'absent-minded', category: '상태' },
  { phrase: '골머리를 앓다', translation: 'troubled', category: '감정' },
  { phrase: '골탕을 먹이다', translation: 'get revenge', category: '동작' },
  { phrase: '골병이 들다', translation: 'fall ill from stress', category: '상황' },
  { phrase: '피를 말리다', translation: 'make anxious', category: '동작' },
  { phrase: '피가 거꾸로 솟다', translation: 'enraged', category: '감정' },
  { phrase: '살이 빠지다', translation: 'lose weight', category: '상태' },
  { phrase: '살이 찌다', translation: 'gain weight', category: '상태' },
  { phrase: '살을 깎다', translation: 'make great effort', category: '동작' },
  { phrase: '뼈가 빠지다', translation: 'work hard', category: '상황' },
  { phrase: '뼈를 깎다', translation: 'make painful sacrifice', category: '동작' },
  { phrase: '뼈에 사무치다', translation: 'deeply hurt', category: '감정' },
  { phrase: '입술이 타다', translation: 'desperately need', category: '상황' },
  { phrase: '입술을 깨물다', translation: 'hold back anger', category: '동작' },
  { phrase: '혀를 차다', translation: 'click tongue (disapprove)', category: '동작' },
  { phrase: '혀를 내두르다', translation: 'admire greatly', category: '반응' },
  { phrase: '이를 갈다', translation: 'grind teeth (vengeful)', category: '감정' },
  { phrase: '이가 빠지다', translation: 'make no sense', category: '상황' },
  { phrase: '코를 납작하게 하다', translation: 'humble someone', category: '동작' },
  { phrase: '코를 찌르다', translation: 'stink', category: '상황' },
  { phrase: '콧방귀를 뀌다', translation: 'snort (dismiss)', category: '동작' },
  { phrase: '콧대가 높다', translation: 'snobbish', category: '성격' },
  { phrase: '콧노래를 부르다', translation: 'hum (happy)', category: '동작' },
  { phrase: '목구멍이 포도청', translation: 'desperate for living', category: '상황' },
  { phrase: '목에 힘을 주다', translation: 'act superior', category: '태도' },
  { phrase: '목이 쉬다', translation: 'voice hoarse', category: '상태' },
  { phrase: '허리를 굽히다', translation: 'bow (respect)', category: '동작' },
  { phrase: '허리띠를 졸라매다', translation: 'tighten belt', category: '동작' },
  { phrase: '가슴팍을 치다', translation: 'beat chest (regret)', category: '동작' },
  { phrase: '속이 뒤집히다', translation: 'nauseating', category: '감정' },
  { phrase: '속이 타다', translation: 'anxious', category: '감정' },
  { phrase: '속이 시원하다', translation: 'satisfied', category: '감정' },
  { phrase: '속이 상하다', translation: 'upset', category: '감정' },
  { phrase: '속이 검다', translation: 'scheming', category: '성격' },
  { phrase: '속을 끓이다', translation: 'make someone worry', category: '동작' },
  { phrase: '속을 썩이다', translation: 'cause worry', category: '동작' },
  { phrase: '속을 태우다', translation: 'make anxious', category: '동작' },
  { phrase: '간에 기별도 안 가다', translation: 'not enough', category: '상황' },
  { phrase: '간이 콩알만 하다', translation: 'very scared', category: '감정' },
  { phrase: '간이 부었다', translation: 'audacious', category: '성격' },
  { phrase: '쓸개가 붓다', translation: 'fearless', category: '성격' },
  { phrase: '심장이 쫄깃하다', translation: 'thrilling', category: '감정' },
  { phrase: '심장이 터질 것 같다', translation: 'heart pounding', category: '감정' },
  { phrase: '애간장이 타다', translation: 'heartbroken', category: '감정' },
  { phrase: '애를 태우다', translation: 'make someone worry', category: '동작' },
  { phrase: '애를 먹다', translation: 'struggle', category: '상황' },
  { phrase: '애를 쓰다', translation: 'make effort', category: '동작' },
  { phrase: '낯을 가리다', translation: 'shy with strangers', category: '성격' },
  { phrase: '낯이 두껍다', translation: 'shameless', category: '성격' },
  { phrase: '낯을 붉히다', translation: 'blush', category: '반응' },
  { phrase: '낯이 뜨겁다', translation: 'ashamed', category: '감정' },
  { phrase: '얼굴을 들다', translation: 'show face', category: '동작' },
  { phrase: '얼굴을 붉히다', translation: 'get angry', category: '반응' },
  { phrase: '얼굴이 펴다', translation: 'proud', category: '감정' },
  { phrase: '얼굴에 먹칠하다', translation: 'disgrace', category: '동작' },
  { phrase: '얼굴이 반쪽이 되다', translation: 'lose weight (from worry)', category: '상태' },
  { phrase: '이마에 땀이 나다', translation: 'sweat from effort', category: '상태' },
  { phrase: '이마를 짚다', translation: 'think hard', category: '동작' },
  { phrase: '뺨을 때리다', translation: 'slap face', category: '동작' },
  { phrase: '뺨을 부풀리다', translation: 'sulk', category: '반응' },
  { phrase: '귀를 기울이다', translation: 'listen carefully', category: '동작' },
  { phrase: '귀를 막다', translation: 'ignore', category: '동작' },
  { phrase: '귀를 의심하다', translation: "can't believe ears", category: '반응' },
  { phrase: '귀를 쫑긋하다', translation: 'perk up ears', category: '동작' },
  { phrase: '귀가 얇다', translation: 'easily influenced', category: '성격' },
  { phrase: '귀가 솔깃하다', translation: 'interested', category: '반응' },
  { phrase: '귀가 번쩍 뜨이다', translation: 'pay attention', category: '반응' },
  { phrase: '귀를 기울이다', translation: 'listen attentively', category: '동작' },
  { phrase: '귀에 못이 박히도록', translation: 'hear repeatedly', category: '상황' },
  { phrase: '발을 빼다', translation: 'withdraw', category: '동작' },
  { phrase: '발을 들이다', translation: 'get involved', category: '동작' },
  { phrase: '발을 동동 구르다', translation: 'frustrated', category: '반응' },
  { phrase: '발을 맞추다', translation: 'coordinate', category: '동작' },
  { phrase: '발을 끊다', translation: 'stop visiting', category: '동작' },
  { phrase: '발길을 돌리다', translation: 'turn back', category: '동작' },
  { phrase: '발길이 떨어지지 않다', translation: 'reluctant to leave', category: '감정' },

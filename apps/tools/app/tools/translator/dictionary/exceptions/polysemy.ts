...
export const KOREAN_POLYSEMY: PolysemyEntry[] = [
	// 가장 흔한 동음이의어 (100개)
	{
		word: '배',
		senses: [
			{ meaning: '과일', translation: 'pear', context: ['먹다', '달다', '맛있다'], example: '배를 먹다' },
			{ meaning: '교통수단', translation: 'ship', context: ['타다', '항구', '바다'], example: '배를 타다' },
			{ meaning: '신체부위', translation: 'stomach', context: ['아프다', '고프다', '부르다'], example: '배가 아프다' },
	...
	},
	{
		word: '밤',
		senses: [
			{ meaning: '시간', translation: 'night', context: ['어둡다', '자다', '늦다'], example: '밤에 자다' },
			{ meaning: '과일', translation: 'chestnut', context: ['먹다', '맛있다', '가을'], example: '밤을 먹다' },
		],
	},
	{
		word: '눈',
		senses: [
			{ meaning: '신체부위', translation: 'eye', context: ['보다', '뜨다', '감다'], example: '눈을 뜨다' },
			{ meaning: '날씨', translation: 'snow', context: ['오다', '내리다', '쌓이다'], example: '눈이 오다' },
		],
	},
	{
		word: '손',
		senses: [
			{ meaning: '신체부위', translation: 'hand', context: ['씻다', '잡다', '들다'], example: '손을 씻다' },
			{ meaning: '손님', translation: 'guest', context: ['오다', '많다', '모시다'], example: '손이 많다' },
		],
	},
	{
		word: '발',
		senses: [
			{ meaning: '신체부위', translation: 'foot', context: ['씻다', '걷다', '디디다'], example: '발을 씻다' },
			{ meaning: '발포', translation: 'shot', context: ['쏘다', '총', '대포'], example: '총을 발하다' },
			{ meaning: '발행', translation: 'issue', context: ['하다', '증명서', '면허'], example: '면허를 발하다' },
		],
	},
	{
		word: '말',
		senses: [
			{ meaning: '언어', translation: 'word', context: ['하다', '듣다', '이야기'], example: '말을 하다' },
			{ meaning: '동물', translation: 'horse', context: ['타다', '달리다', '농장'], example: '말을 타다' },
	...
	},
	{
		word: '장',
		senses: [
			{ meaning: '시장', translation: 'market', context: ['보다', '가다', '서다'], example: '장을 보다' },
			{ meaning: '방', translation: 'room', context: ['안방', '대청'], example: '안방 장' },
			{ meaning: '문서', translation: 'chapter', context: ['책', '논문'], example: '제1장' },
			{ meaning: '묘지', translation: 'grave', context: ['모시다', '성묘'], example: '장을 모시다' },
		],
	},
	{
		word: '차',
		senses: [
			{ meaning: '음료', translation: 'tea', context: ['마시다', '뜨겁다', '녹차'], example: '차를 마시다' },
			{ meaning: '교통수단', translation: 'car', context: ['타다', '운전하다', '주차'], example: '차를 타다' },
			{ meaning: '차이', translation: 'difference', context: ['나다', '크다', '작다'], example: '차가 나다' },
		],
	},
	{
		word: '골',
		senses: [
			{ meaning: '득점', translation: 'goal', context: ['넣다', '축구', '경기'], example: '골을 넣다' },
			{ meaning: '골짜기', translation: 'valley', context: ['산', '깊다', '계곡'], example: '깊은 골' },
			{ meaning: '골칫거리', translation: 'trouble', context: ['썩다', '문제'], example: '골이 썩다' },
		],
	},
	{
		word: '감',
		senses: [
			{ meaning: '과일', translation: 'persimmon', context: ['먹다', '달다', '가을'], example: '감을 먹다' },
			{ meaning: '느낌', translation: 'feeling', context: ['잡다', '오다', '좋다'], example: '감이 오다' },
		],
	},
	...
	// 자주 쓰이는 동음이의어 (200개)
	{
		word: '가지',
		senses: [
			{ meaning: '채소', translation: 'eggplant', context: ['먹다', '요리'], example: '가지를 먹다' },
			{ meaning: '나뭇가지', translation: 'branch', context: ['나무', '자르다'], example: '나뭇가지' },
	...
	},
	{
		word: '기',
		senses: [
			{ meaning: '에너지', translation: 'energy', context: ['세다', '약하다'], example: '기가 세다' },
			{ meaning: '깃발', translation: 'flag', context: ['달다', '휘날리다'], example: '기를 달다' },
			{ meaning: '증기', translation: 'steam', context: ['나다', '찌다'], example: '기가 나다' },
			{ meaning: '기회', translation: 'opportunity', context: ['놓치다', '잡다'], example: '기를 놓치다' },
		],
	},
	{
		word: '김',
		senses: [
			{ meaning: '수증기', translation: 'steam', context: ['나다', '서리다'], example: '김이 나다' },
			{ meaning: '해조류', translation: 'seaweed', context: ['먹다', '말리다'], example: '김을 먹다' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '목재', translation: 'wood', context: ['만들다', '재료'], example: '나무로 만들다' },
		],
	},
	{
		word: '단',
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '행정구역', translation: 'province', context: ['경기', '강원'], example: '경기도' },
		],
	},
	{
		word: '동',
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '절반', translation: 'half', context: ['나누다', '절반'], example: '반으로 나누다' },
	...
	},
	{
		word: '방',
		senses: [
			{ meaning: '공간', translation: 'room', context: ['들어가다', '청소'], example: '방을 청소하다' },
	...
	},
	{
		word: '별',
		senses: [
			{ meaning: '천체', translation: 'star', context: ['밤하늘', '빛나다'], example: '별이 빛나다' },
			{ meaning: '특별한', translation: 'special', context: ['이상한', '다른'], example: '별거 아니다' },
		],
	},
	{
		word: '불',
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '분위기', translation: 'atmosphere', context: ['다른', '특별'], example: '다른 색' },
		],
	},
	{
		word: '선',
	...
	},
	{
		word: '실',
		senses: [
			{ meaning: '실꾸리', translation: 'thread', context: ['바느질', '감다'], example: '실을 감다' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '보조사', translation: 'particle', context: ['않다', '말다'], example: '-지 않다' },
		],
	},
	{
		word: '진',
	...
	},
	{
		word: '집',
		senses: [
			{ meaning: '주거', translation: 'house', context: ['살다', '들어가다'], example: '집에 가다' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '차이', translation: 'difference', context: ['나다', '벌어지다'], example: '차가 나다' },
	...
	},
	{
		word: '피',
		senses: [
			{ meaning: '혈액', translation: 'blood', context: ['흐르다', '빨갛다'], example: '피가 나다' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '생선회', translation: 'raw fish', context: ['먹다', '맛있다'], example: '회를 먹다' },
		],
	},
	{
		word: '효',
	...
	// 추가 동음이의어 (700개) - 축약 버전
	{ word: '감다', senses: [{ meaning: '눈을 감다', translation: 'close eyes' }, { meaning: '머리를 감다', translation: 'wash hair' }] },
	{ word: '가다', senses: [{ meaning: '이동하다', translation: 'go' }, { meaning: '날카롭다', translation: 'sharp' }] },
	{ word: '걸다', senses: [{ meaning: '걸어가다', translation: 'walk' }, { meaning: '전화를 걸다', translation: 'call' }, { meaning: '걸다(옷)', translation: 'hang' }] },
	{ word: '타다', senses: [{ meaning: '불이 타다', translation: 'burn' }, { meaning: '차를 타다', translation: 'ride' }] },
	{ word: '치다', senses: [{ meaning: '때리다', translation: 'hit' }, { meaning: '피아노를 치다', translation: 'play' }, { meaning: '번개가 치다', translation: 'strike' }] },
	{ word: '쓰다', senses: [{ meaning: '글을 쓰다', translation: 'write' }, { meaning: '모자를 쓰다', translation: 'wear (hat)' }, { meaning: '맛이 쓰다', translation: 'bitter' }] },
	{ word: '들다', senses: [{ meaning: '손에 들다', translation: 'hold' }, { meaning: '병이 들다', translation: 'get sick' }, { meaning: '집에 들다', translation: 'enter' }] },
	{ word: '빠지다', senses: [{ meaning: '물에 빠지다', translation: 'fall into' }, { meaning: '좋아하다', translation: 'be into' }] },
	{ word: '보다', senses: [{ meaning: '눈으로 보다', translation: 'see' }, { meaning: '시험을 보다', translation: 'take (test)' }, { meaning: '~보다 크다', translation: 'than' }] },
	{ word: '먹다', senses: [{ meaning: '음식을 먹다', translation: 'eat' }, { meaning: '나이를 먹다', translation: 'age' }, { meaning: '잉크를 먹다', translation: 'absorb' }] },
];
...
export const ENGLISH_POLYSEMY: PolysemyEntry[] = [
	// 가장 흔한 동음이의어 (100개)
	{
		word: 'set',
		senses: [
			{ meaning: '놓다', translation: '놓다', context: ['table', 'down'], example: 'set the table' },
			{ meaning: '세트', translation: '세트', context: ['of', 'collection'], example: 'a set of dishes' },
			{ meaning: '설정하다', translation: '설정하다', context: ['up', 'alarm'], example: 'set an alarm' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '운영하다', translation: '운영하다', context: ['business', 'company'], example: 'run a business' },
			{ meaning: '작동하다', translation: '작동하다', context: ['machine', 'program'], example: 'run a program' },
			{ meaning: '흐르다', translation: '흐르다', context: ['water', 'river'], example: 'water runs' },
		],
	},
	{
		word: 'get',
		senses: [
			{ meaning: '얻다', translation: '얻다', context: ['receive', 'obtain'], example: 'get a gift' },
			{ meaning: '도착하다', translation: '도착하다', context: ['arrive', 'home'], example: 'get home' },
			{ meaning: '이해하다', translation: '이해하다', context: ['understand'], example: 'I get it' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '가벼운', translation: '가벼운', context: ['weight', 'heavy'], example: 'light weight' },
			{ meaning: '켜다', translation: '켜다', context: ['fire', 'candle'], example: 'light a candle' },
		],
	},
	{
		word: 'left',
		senses: [
			{ meaning: '왼쪽', translation: '왼쪽', context: ['right', 'direction'], example: 'turn left' },
			{ meaning: '떠났다', translation: '떠났다', context: ['went', 'departed'], example: 'he left' },
	...
	},
	{
		word: 'right',
		senses: [
			{ meaning: '오른쪽', translation: '오른쪽', context: ['left', 'direction'], example: 'turn right' },
			{ meaning: '옳은', translation: '옳은', context: ['correct', 'wrong'], example: 'right answer' },
			{ meaning: '권리', translation: '권리', context: ['human', 'legal'], example: 'human rights' },
		],
	},
	{
		word: 'mean',
		senses: [
			{ meaning: '의미하다', translation: '의미하다', context: ['signify'], example: 'what does it mean' },
			{ meaning: '의도하다', translation: '의도하다', context: ['intend'], example: 'I mean to go' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '견디다', translation: '견디다', context: ['endure', 'tolerate'], example: 'bear pain' },
	...
	},
	{
		...
		senses: [
			...
			{ meaning: '데이트', translation: '데이트', context: ['romantic', 'meet'], example: 'go on a date' },
	...
	},
	{
		word: 'fair',
		senses: [
			{ meaning: '공정한', translation: '공정한', context: ['just', 'equal'], example: 'fair game' },
			{ meaning: '박람회', translation: '박람회', context: ['exhibition'], example: 'trade fair' },
			{ meaning: '밝은', translation: '밝은', context: ['light', 'complexion'], example: 'fair skin' },
		],
	},

	// 자주 쓰이는 동음이의어 (900개) - 축약 버전
	{ word: 'bank', senses: [{ meaning: '은행', translation: '은행' }, { meaning: '강둑', translation: '강둑' }] },
	{ word: 'bat', senses: [{ meaning: '박쥐', translation: '박쥐' }, { meaning: '야구방망이', translation: '배트' }] },
	{ word: 'bowl', senses: [{ meaning: '그릇', translation: '그릇' }, { meaning: '볼링하다', translation: '볼링하다' }] },
	{ word: 'box', senses: [{ meaning: '상자', translation: '상자' }, { meaning: '권투하다', translation: '권투하다' }] },
	{ word: 'can', senses: [{ meaning: '할 수 있다', translation: '할 수 있다' }, { meaning: '캔', translation: '캔' }] },
	{ word: 'cap', senses: [{ meaning: '모자', translation: '모자' }, { meaning: '뚜껑', translation: '뚜껑' }] },
	{ word: 'chest', senses: [{ meaning: '가슴', translation: '가슴' }, { meaning: '상자', translation: '궤짝' }] },
	{ word: 'club', senses: [{ meaning: '동아리', translation: '클럽' }, { meaning: '골프채', translation: '클럽' }] },
	{ word: 'cold', senses: [{ meaning: '추운', translation: '추운' }, { meaning: '감기', translation: '감기' }] },
	{ word: 'court', senses: [{ meaning: '법정', translation: '법원' }, { meaning: '코트', translation: '경기장' }] },
	{ word: 'current', senses: [{ meaning: '현재의', translation: '현재의' }, { meaning: '전류', translation: '전류' }] },
	{ word: 'duck', senses: [{ meaning: '오리', translation: '오리' }, { meaning: '피하다', translation: '피하다' }] },
	{ word: 'fan', senses: [{ meaning: '선풍기', translation: '선풍기' }, { meaning: '팬', translation: '팬' }] },
	{ word: 'file', senses: [{ meaning: '파일', translation: '파일' }, { meaning: '줄', translation: '줄' }] },
	{ word: 'fine', senses: [{ meaning: '좋은', translation: '좋은' }, { meaning: '벌금', translation: '벌금' }] },
	{ word: 'fly', senses: [{ meaning: '날다', translation: '날다' }, { meaning: '파리', translation: '파리' }] },
	{ word: 'foot', senses: [{ meaning: '발', translation: '발' }, { meaning: '피트', translation: '피트' }] },
	{ word: 'glass', senses: [{ meaning: '유리', translation: '유리' }, { meaning: '잔', translation: '잔' }] },
	{ word: 'ground', senses: [{ meaning: '땅', translation: '땅' }, { meaning: '갈다(과거)', translation: '갈았다' }] },
	{ word: 'hand', senses: [{ meaning: '손', translation: '손' }, { meaning: '건네다', translation: '건네다' }] },
	{ word: 'hide', senses: [{ meaning: '숨기다', translation: '숨기다' }, { meaning: '가죽', translation: '가죽' }] },
	{ word: 'kind', senses: [{ meaning: '친절한', translation: '친절한' }, { meaning: '종류', translation: '종류' }] },
	{ word: 'last', senses: [{ meaning: '마지막', translation: '마지막' }, { meaning: '지속하다', translation: '지속하다' }] },
	{ word: 'lead', senses: [{ meaning: '이끌다', translation: '이끌다' }, { meaning: '납', translation: '납' }] },
	{ word: 'letter', senses: [{ meaning: '편지', translation: '편지' }, { meaning: '글자', translation: '글자' }] },
	{ word: 'lie', senses: [{ meaning: '거짓말', translation: '거짓말' }, { meaning: '눕다', translation: '눕다' }] },
	{ word: 'live', senses: [{ meaning: '살다', translation: '살다' }, { meaning: '생방송의', translation: '생방송' }] },
	{ word: 'match', senses: [{ meaning: '성냥', translation: '성냥' }, { meaning: '경기', translation: '경기' }, { meaning: '맞다', translation: '맞다' }] },
	{ word: 'mine', senses: [{ meaning: '나의것', translation: '나의것' }, { meaning: '광산', translation: '광산' }] },
	{ word: 'miss', senses: [{ meaning: '놓치다', translation: '놓치다' }, { meaning: '그리워하다', translation: '그리워하다' }] },
	{ word: 'park', senses: [{ meaning: '공원', translation: '공원' }, { meaning: '주차하다', translation: '주차하다' }] },
	{ word: 'pen', senses: [{ meaning: '펜', translation: '펜' }, { meaning: '우리', translation: '우리' }] },
	{ word: 'pitch', senses: [{ meaning: '던지다', translation: '던지다' }, { meaning: '음높이', translation: '음높이' }] },
	{ word: 'plant', senses: [{ meaning: '식물', translation: '식물' }, { meaning: '공장', translation: '공장' }] },
	{ word: 'point', senses: [{ meaning: '점', translation: '점' }, { meaning: '가리키다', translation: '가리키다' }] },
	{ word: 'pound', senses: [{ meaning: '파운드', translation: '파운드' }, { meaning: '두드리다', translation: '두드리다' }] },
	{ word: 'present', senses: [{ meaning: '선물', translation: '선물' }, { meaning: '현재의', translation: '현재의' }, { meaning: '발표하다', translation: '발표하다' }] },
	{ word: 'record', senses: [{ meaning: '기록', translation: '기록' }, { meaning: '녹음하다', translation: '녹음하다' }] },
	{ word: 'rock', senses: [{ meaning: '바위', translation: '바위' }, { meaning: '흔들다', translation: '흔들다' }] },
	{ word: 'rose', senses: [{ meaning: '장미', translation: '장미' }, { meaning: '일어났다', translation: '일어났다' }] },
	{ word: 'saw', senses: [{ meaning: '톱', translation: '톱' }, { meaning: '보았다', translation: '보았다' }] },
	{ word: 'second', senses: [{ meaning: '두번째', translation: '두번째' }, { meaning: '초', translation: '초' }] },
	{ word: 'sentence', senses: [{ meaning: '문장', translation: '문장' }, { meaning: '형벌', translation: '형벌' }] },
	{ word: 'spring', senses: [{ meaning: '봄', translation: '봄' }, { meaning: '용수철', translation: '용수철' }, { meaning: '샘', translation: '샘' }] },
	{ word: 'star', senses: [{ meaning: '별', translation: '별' }, { meaning: '스타', translation: '스타' }] },
	{ word: 'stick', senses: [{ meaning: '막대기', translation: '막대기' }, { meaning: '붙이다', translation: '붙이다' }] },
	{ word: 'tear', senses: [{ meaning: '눈물', translation: '눈물' }, { meaning: '찢다', translation: '찢다' }] },
	{ word: 'watch', senses: [{ meaning: '시계', translation: '시계' }, { meaning: '보다', translation: '보다' }] },
	{ word: 'wave', senses: [{ meaning: '파도', translation: '파도' }, { meaning: '흔들다', translation: '흔들다' }] },
	{ word: 'well', senses: [{ meaning: '잘', translation: '잘' }, { meaning: '우물', translation: '우물' }] },
	{ word: 'wind', senses: [{ meaning: '바람', translation: '바람' }, { meaning: '감다', translation: '감다' }] },
];
 ...
 * 문맥 기반 의미 선택
 */
export function disambiguateByContext(word: string, context: string[], language: 'ko' | 'en'): PolysemySense | null {
	...
	for (const sense of entry.senses) {
		...
		const matches = sense.context.filter((ctx) => context.some((c) => c.includes(ctx) || ctx.includes(c))).length;

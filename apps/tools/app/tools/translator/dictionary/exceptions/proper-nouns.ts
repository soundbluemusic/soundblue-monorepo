...
export const KOREAN_PROPER_NOUNS: ProperNounEntry[] = [
	...
	{ original: '헌법재판소', english: 'Constitutional Court', type: 'organization', category: 'government' },
	{ original: '서울대학교', english: 'Seoul National University', type: 'organization', category: 'university' },
	{ original: '연세대학교', english: 'Yonsei University', type: 'organization', category: 'university' },
	{ original: '고려대학교', english: 'Korea University', type: 'organization', category: 'university' },
	...
	{ original: '이상한 변호사 우영우', english: 'Extraordinary Attorney Woo', type: 'title', category: 'tv' },
...
export const ENGLISH_PROPER_NOUNS: ProperNounEntry[] = [
	...
	{ original: 'Abraham Lincoln', korean: '에이브러햄 링컨', type: 'person', category: 'politician' },
	...
	{ original: 'Mark Zuckerberg', korean: '마크 저커버그', type: 'person', category: 'entrepreneur' },
	...
	// 역사적 인물
	{ original: 'Albert Einstein', korean: '알베르트 아인슈타인', type: 'person', category: 'scientist' },
	...
	{ original: 'Leonardo da Vinci', korean: '레오나르도 다빈치', type: 'person', category: 'artist' },
	{ original: 'Pablo Picasso', korean: '파블로 피카소', type: 'person', category: 'artist' },
	{ original: 'William Shakespeare', korean: '윌리엄 셰익스피어', type: 'person', category: 'writer' },
	...
	// 대학
	{ original: 'Harvard University', korean: '하버드 대학교', type: 'organization', category: 'university' },
	{ original: 'Stanford University', korean: '스탠퍼드 대학교', type: 'organization', category: 'university' },
	{ original: 'MIT', korean: 'MIT', type: 'organization', category: 'university' },
	{ original: 'Yale University', korean: '예일 대학교', type: 'organization', category: 'university' },
	{ original: 'Oxford University', korean: '옥스퍼드 대학교', type: 'organization', category: 'university' },
	{ original: 'Cambridge University', korean: '케임브리지 대학교', type: 'organization', category: 'university' },

	// 국제기구
	{ original: 'United Nations', korean: '유엔', type: 'organization', category: 'international' },
	{ original: 'World Health Organization', korean: '세계보건기구', type: 'organization', category: 'international' },
 ...
 * 타입별 고유명사
 */
export function getProperNounsByType(type: ProperNounType, language: 'ko' | 'en'): ProperNounEntry[] {
	const list = language === 'ko' ? KOREAN_PROPER_NOUNS : ENGLISH_PROPER_NOUNS;

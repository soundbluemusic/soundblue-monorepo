...
export const KOREAN_IRREGULARS: KoreanIrregular[] = [
	...
	// ========================================
	{ base: '듣', type: 'ㄷ→ㄹ', conjugations: { past: '들었다', present: '듣는다', polite: '들어요' } },
	{ base: '걷', type: 'ㄷ→ㄹ', conjugations: { past: '걸었다', present: '걷는다', polite: '걸어요' } },
	{ base: '묻', type: 'ㄷ→ㄹ', conjugations: { past: '물었다', present: '묻는다', polite: '물어요' } },
	{ base: '싣', type: 'ㄷ→ㄹ', conjugations: { past: '실었다', present: '싣는다', polite: '실어요' } },
	{ base: '깨닫', type: 'ㄷ→ㄹ', conjugations: { past: '깨달았다', present: '깨닫는다', polite: '깨달아요' } },
	{ base: '받', type: 'ㄷ→ㄹ', conjugations: { past: '받았다', present: '받는다', polite: '받아요' } },
	{ base: '얻', type: 'ㄷ→ㄹ', conjugations: { past: '얻었다', present: '얻는다', polite: '얻어요' } },
	{ base: '믿', type: 'ㄷ→ㄹ', conjugations: { past: '믿었다', present: '믿는다', polite: '믿어요' } },
	{ base: '닫', type: 'ㄷ→ㄹ', conjugations: { past: '닫았다', present: '닫는다', polite: '닫아요' } },
	{ base: '묻', type: 'ㄷ→ㄹ', conjugations: { past: '묻었다', present: '묻는다', polite: '묻어요' } },
	{ base: '벋', type: 'ㄷ→ㄹ', conjugations: { past: '벋었다', present: '벋는다', polite: '벋어요' } },
	{ base: '쏟', type: 'ㄷ→ㄹ', conjugations: { past: '쏟았다', present: '쏟는다', polite: '쏟아요' } },
	{ base: '겯', type: 'ㄷ→ㄹ', conjugations: { past: '겯었다', present: '겯는다', polite: '겯어요' } },
	{ base: '붇', type: 'ㄷ→ㄹ', conjugations: { past: '불었다', present: '붇는다', polite: '불어요' } },
	{ base: '뜯', type: 'ㄷ→ㄹ', conjugations: { past: '뜯었다', present: '뜯는다', polite: '뜯어요' } },
	{ base: '굳', type: 'ㄷ→ㄹ', conjugations: { past: '굳었다', present: '굳는다', polite: '굳어요' } },
	{ base: '붙', type: 'ㄷ→ㄹ', conjugations: { past: '붙었다', present: '붙는다', polite: '붙어요' } },
	{ base: '눋', type: 'ㄷ→ㄹ', conjugations: { past: '눋었다', present: '눋는다', polite: '눋어요' } },
	{ base: '빗', type: 'ㄷ→ㄹ', conjugations: { past: '빗었다', present: '빗는다', polite: '빗어요' } },
	{ base: '깨뜨리', type: 'ㄷ→ㄹ', conjugations: { past: '깨뜨렸다', present: '깨뜨린다', polite: '깨뜨려요' } },
	{ base: '긷', type: 'ㄷ→ㄹ', conjugations: { past: '긷었다', present: '긷는다', polite: '긷어요' } },
	{ base: '믿', type: 'ㄷ→ㄹ', conjugations: { past: '믿었다', present: '믿는다', polite: '믿어요' } },
	{ base: '깃', type: 'ㄷ→ㄹ', conjugations: { past: '깃었다', present: '깃는다', polite: '깃어요' } },
	{ base: '묻히', type: 'ㄷ→ㄹ', conjugations: { past: '묻혔다', present: '묻힌다', polite: '묻혀요' } },
	{ base: '닫히', type: 'ㄷ→ㄹ', conjugations: { past: '닫혔다', present: '닫힌다', polite: '닫혀요' } },
	{ base: '깨달', type: 'ㄷ→ㄹ', conjugations: { past: '깨달았다', present: '깨닫는다', polite: '깨달아요' } },
	{ base: '믿', type: 'ㄷ→ㄹ', conjugations: { past: '믿었다', present: '믿는다', polite: '믿어요' } },
	{ base: '닫', type: 'ㄷ→ㄹ', conjugations: { past: '닫았다', present: '닫는다', polite: '닫아요' } },
	{ base: '받', type: 'ㄷ→ㄹ', conjugations: { past: '받았다', present: '받는다', polite: '받아요' } },
	{ base: '묻', type: 'ㄷ→ㄹ', conjugations: { past: '물었다', present: '묻는다', polite: '물어요' } },
	...
	// ========================================
	{ base: '춥', type: 'ㅂ→우', conjugations: { past: '추웠다', present: '춥다', polite: '추워요' } },
	{ base: '덥', type: 'ㅂ→우', conjugations: { past: '더웠다', present: '덥다', polite: '더워요' } },
	{ base: '아름답', type: 'ㅂ→우', conjugations: { past: '아름다웠다', present: '아름답다', polite: '아름다워요' } },
	{ base: '가볍', type: 'ㅂ→우', conjugations: { past: '가벼웠다', present: '가볍다', polite: '가벼워요' } },
	{ base: '무겁', type: 'ㅂ→우', conjugations: { past: '무거웠다', present: '무겁다', polite: '무거워요' } },
	{ base: '쉽', type: 'ㅂ→우', conjugations: { past: '쉬웠다', present: '쉽다', polite: '쉬워요' } },
	{ base: '어렵', type: 'ㅂ→우', conjugations: { past: '어려웠다', present: '어렵다', polite: '어려워요' } },
	{ base: '가깝', type: 'ㅂ→우', conjugations: { past: '가까웠다', present: '가깝다', polite: '가까워요' } },
	{ base: '즐겁', type: 'ㅂ→우', conjugations: { past: '즐거웠다', present: '즐겁다', polite: '즐거워요' } },
	{ base: '슬프', type: 'ㅂ→우', conjugations: { past: '슬펐다', present: '슬프다', polite: '슬퍼요' } },
	{ base: '괴롭', type: 'ㅂ→우', conjugations: { past: '괴로웠다', present: '괴롭다', polite: '괴로워요' } },
	{ base: '아프', type: 'ㅂ→우', conjugations: { past: '아팠다', present: '아프다', polite: '아파요' } },
	{ base: '고프', type: 'ㅂ→우', conjugations: { past: '고팠다', present: '고프다', polite: '고파요' } },
	{ base: '굽', type: 'ㅂ→우', conjugations: { past: '구웠다', present: '굽다', polite: '구워요' } },
	{ base: '눕', type: 'ㅂ→우', conjugations: { past: '누웠다', present: '눕다', polite: '누워요' } },
	{ base: '줍', type: 'ㅂ→우', conjugations: { past: '주웠다', present: '줍다', polite: '주워요' } },
	{ base: '곱', type: 'ㅂ→우', conjugations: { past: '고왔다', present: '곱다', polite: '고와요' } },
	{ base: '돕', type: 'ㅂ→우', conjugations: { past: '도왔다', present: '돕다', polite: '도와요' } },
	{ base: '뜨겁', type: 'ㅂ→우', conjugations: { past: '뜨거웠다', present: '뜨겁다', polite: '뜨거워요' } },
	{ base: '차갑', type: 'ㅂ→우', conjugations: { past: '차가웠다', present: '차갑다', polite: '차가워요' } },
	{ base: '맵', type: 'ㅂ→우', conjugations: { past: '매웠다', present: '맵다', polite: '매워요' } },
	{ base: '반갑', type: 'ㅂ→우', conjugations: { past: '반가웠다', present: '반갑다', polite: '반가워요' } },
	{ base: '미덥', type: 'ㅂ→우', conjugations: { past: '미더웠다', present: '미덥다', polite: '미더워요' } },
	{ base: '그립', type: 'ㅂ→우', conjugations: { past: '그리웠다', present: '그립다', polite: '그리워요' } },
	{ base: '귀엽', type: 'ㅂ→우', conjugations: { past: '귀여웠다', present: '귀엽다', polite: '귀여워요' } },
	{ base: '밉', type: 'ㅂ→우', conjugations: { past: '미웠다', present: '밉다', polite: '미워요' } },
	{ base: '고맙', type: 'ㅂ→우', conjugations: { past: '고마웠다', present: '고맙다', polite: '고마워요' } },
	{ base: '반갑', type: 'ㅂ→우', conjugations: { past: '반가웠다', present: '반갑다', polite: '반가워요' } },
	{ base: '시끄럽', type: 'ㅂ→우', conjugations: { past: '시끄러웠다', present: '시끄럽다', polite: '시끄러워요' } },
	{ base: '부끄럽', type: 'ㅂ→우', conjugations: { past: '부끄러웠다', present: '부끄럽다', polite: '부끄러워요' } },
	{ base: '두렵', type: 'ㅂ→우', conjugations: { past: '두려웠다', present: '두렵다', polite: '두려워요' } },
	{ base: '따뜻하', type: 'ㅂ→우', conjugations: { past: '따뜻했다', present: '따뜻하다', polite: '따뜻해요' } },
	{ base: '차갑', type: 'ㅂ→우', conjugations: { past: '차가웠다', present: '차갑다', polite: '차가워요' } },
	{ base: '시럽', type: 'ㅂ→우', conjugations: { past: '시러웠다', present: '시럽다', polite: '시러워요' } },
	{ base: '간지럽', type: 'ㅂ→우', conjugations: { past: '간지러웠다', present: '간지럽다', polite: '간지러워요' } },
	{ base: '외롭', type: 'ㅂ→우', conjugations: { past: '외로웠다', present: '외롭다', polite: '외로워요' } },
	{ base: '바쁘', type: 'ㅂ→우', conjugations: { past: '바빴다', present: '바쁘다', polite: '바빠요' } },
	{ base: '기쁘', type: 'ㅂ→우', conjugations: { past: '기뻤다', present: '기쁘다', polite: '기뻐요' } },
	{ base: '쓰', type: 'ㅂ→우', conjugations: { past: '썼다', present: '쓰다', polite: '써요' } },
	{ base: '아쉽', type: 'ㅂ→우', conjugations: { past: '아쉬웠다', present: '아쉽다', polite: '아쉬워요' } },
	{ base: '서럽', type: 'ㅂ→우', conjugations: { past: '서러웠다', present: '서럽다', polite: '서러워요' } },
	{ base: '괴롭', type: 'ㅂ→우', conjugations: { past: '괴로웠다', present: '괴롭다', polite: '괴로워요' } },
	{ base: '밉', type: 'ㅂ→우', conjugations: { past: '미웠다', present: '밉다', polite: '미워요' } },
	{ base: '곱', type: 'ㅂ→우', conjugations: { past: '고왔다', present: '곱다', polite: '고와요' } },
	{ base: '돕', type: 'ㅂ→우', conjugations: { past: '도왔다', present: '돕다', polite: '도와요' } },
	...
	// ========================================
	{ base: '짓', type: 'ㅅ탈락', conjugations: { past: '지었다', present: '짓는다', polite: '지어요' } },
	{ base: '낫', type: 'ㅅ탈락', conjugations: { past: '나았다', present: '낫다', polite: '나아요' } },
	{ base: '붓', type: 'ㅅ탈락', conjugations: { past: '부었다', present: '붓다', polite: '부어요' } },
	{ base: '긋', type: 'ㅅ탈락', conjugations: { past: '그었다', present: '긋다', polite: '그어요' } },
	{ base: '잇', type: 'ㅅ탈락', conjugations: { past: '이었다', present: '잇다', polite: '이어요' } },
	{ base: '젓', type: 'ㅅ탈락', conjugations: { past: '저었다', present: '젓다', polite: '저어요' } },
	{ base: '굿', type: 'ㅅ탈락', conjugations: { past: '구었다', present: '굿다', polite: '구어요' } },
	{ base: '빗', type: 'ㅅ탈락', conjugations: { past: '비었다', present: '빗다', polite: '비어요' } },
	{ base: '웃', type: 'ㅅ탈락', conjugations: { past: '우었다', present: '웃다', polite: '우어요' } },
	{ base: '있', type: 'ㅅ탈락', conjugations: { past: '이었다', present: '있다', polite: '이어요' } },
	{ base: '핫', type: 'ㅅ탈락', conjugations: { past: '하었다', present: '핫다', polite: '하어요' } },
	{ base: '갓', type: 'ㅅ탈락', conjugations: { past: '가었다', present: '갓다', polite: '가어요' } },
	{ base: '낫', type: 'ㅅ탈락', conjugations: { past: '나았다', present: '낫다', polite: '나아요' } },
	{ base: '짓', type: 'ㅅ탈락', conjugations: { past: '지었다', present: '짓다', polite: '지어요' } },
	{ base: '붓', type: 'ㅅ탈락', conjugations: { past: '부었다', present: '붓다', polite: '부어요' } },
	{ base: '긋', type: 'ㅅ탈락', conjugations: { past: '그었다', present: '긋다', polite: '그어요' } },
	{ base: '잇', type: 'ㅅ탈락', conjugations: { past: '이었다', present: '잇다', polite: '이어요' } },
	{ base: '젓', type: 'ㅅ탈락', conjugations: { past: '저었다', present: '젓다', polite: '저어요' } },
	...
	// ㅎ 탈락 또는 변화
	// ========================================
	{ base: '그렇', type: 'ㅎ탈락', conjugations: { past: '그랬다', present: '그렇다', polite: '그래요' } },
	{ base: '이렇', type: 'ㅎ탈락', conjugations: { past: '이랬다', present: '이렇다', polite: '이래요' } },
	{ base: '저렇', type: 'ㅎ탈락', conjugations: { past: '저랬다', present: '저렇다', polite: '저래요' } },
	{ base: '어떻', type: 'ㅎ탈락', conjugations: { past: '어떻다', present: '어떻다', polite: '어때요' } },
	{ base: '그렇', type: 'ㅎ탈락', conjugations: { past: '그랬다', present: '그렇다', polite: '그래요' } },
	{ base: '까맣', type: 'ㅎ탈락', conjugations: { past: '까맸다', present: '까맣다', polite: '까매요' } },
	{ base: '하얗', type: 'ㅎ탈락', conjugations: { past: '하얬다', present: '하얗다', polite: '하얘요' } },
	{ base: '빨갛', type: 'ㅎ탈락', conjugations: { past: '빨갰다', present: '빨갛다', polite: '빨개요' } },
	{ base: '노랗', type: 'ㅎ탈락', conjugations: { past: '노랬다', present: '노랗다', polite: '노래요' } },
	{ base: '파랗', type: 'ㅎ탈락', conjugations: { past: '파랬다', present: '파랗다', polite: '파래요' } },
	{ base: '그렇', type: 'ㅎ탈락', conjugations: { past: '그랬다', present: '그렇다', polite: '그래요' } },
	{ base: '좋', type: 'ㅎ→ㅏ', conjugations: { past: '좋았다', present: '좋다', polite: '좋아요' } },
	{ base: '많', type: 'ㅎ→ㅏ', conjugations: { past: '많았다', present: '많다', polite: '많아요' } },
	{ base: '않', type: 'ㅎ→ㅏ', conjugations: { past: '않았다', present: '않다', polite: '않아요' } },
	{ base: '놓', type: 'ㅎ→ㅏ', conjugations: { past: '놓았다', present: '놓다', polite: '놓아요' } },
	{ base: '쌓', type: 'ㅎ→ㅏ', conjugations: { past: '쌓았다', present: '쌓다', polite: '쌓아요' } },
	{ base: '낳', type: 'ㅎ→ㅏ', conjugations: { past: '낳았다', present: '낳다', polite: '낳아요' } },
	{ base: '그렇', type: 'ㅎ탈락', conjugations: { past: '그랬다', present: '그렇다', polite: '그래요' } },
	{ base: '이렇', type: 'ㅎ탈락', conjugations: { past: '이랬다', present: '이렇다', polite: '이래요' } },
	{ base: '저렇', type: 'ㅎ탈락', conjugations: { past: '저랬다', present: '저렇다', polite: '저래요' } },
	{ base: '어떻', type: 'ㅎ탈락', conjugations: { past: '어떻다', present: '어떻다', polite: '어때요' } },
	...
	// 르 → ㄹ + 라/러
	// ========================================
	{ base: '부르', type: '르→ㄹ', conjugations: { past: '불렀다', present: '부른다', polite: '불러요' } },
	{ base: '모르', type: '르→ㄹ', conjugations: { past: '몰랐다', present: '모른다', polite: '몰라요' } },
	{ base: '다르', type: '르→ㄹ', conjugations: { past: '달랐다', present: '다르다', polite: '달라요' } },
	{ base: '빠르', type: '르→ㄹ', conjugations: { past: '빨랐다', present: '빠르다', polite: '빨라요' } },
	{ base: '가르치', type: '르→ㄹ', conjugations: { past: '가르쳤다', present: '가르친다', polite: '가르쳐요' } },
	{ base: '자르', type: '르→ㄹ', conjugations: { past: '잘랐다', present: '자른다', polite: '잘라요' } },
	{ base: '누르', type: '르→ㄹ', conjugations: { past: '눌렀다', present: '누른다', polite: '눌러요' } },
	{ base: '고르', type: '르→ㄹ', conjugations: { past: '골랐다', present: '고른다', polite: '골라요' } },
	{ base: '흐르', type: '르→ㄹ', conjugations: { past: '흘렀다', present: '흐른다', polite: '흘러요' } },
	{ base: '오르', type: '르→ㄹ', conjugations: { past: '올랐다', present: '오른다', polite: '올라요' } },
	{ base: '가르치', type: '르→ㄹ', conjugations: { past: '가르쳤다', present: '가르친다', polite: '가르쳐요' } },
	{ base: '치르', type: '르→ㄹ', conjugations: { past: '치렀다', present: '치른다', polite: '치러요' } },
	{ base: '이르', type: '르→ㄹ', conjugations: { past: '이르렀다', present: '이른다', polite: '이르러요' } },
	{ base: '들르', type: '르→ㄹ', conjugations: { past: '들렀다', present: '들른다', polite: '들러요' } },
	{ base: '거르', type: '르→ㄹ', conjugations: { past: '걸렀다', present: '거른다', polite: '거러요' } },
	{ base: '지르', type: '르→ㄹ', conjugations: { past: '질렀다', present: '지른다', polite: '질러요' } },
	{ base: '무르', type: '르→ㄹ', conjugations: { past: '물렀다', present: '무른다', polite: '물러요' } },
	{ base: '서두르', type: '르→ㄹ', conjugations: { past: '서둘렀다', present: '서두른다', polite: '서둘러요' } },
	{ base: '어르', type: '르→ㄹ', conjugations: { past: '얼렀다', present: '어른다', polite: '얼러요' } },
	{ base: '거두르', type: '르→ㄹ', conjugations: { past: '거둘렀다', present: '거두른다', polite: '거둘러요' } },
	{ base: '부르', type: '르→ㄹ', conjugations: { past: '불렀다', present: '부른다', polite: '불러요' } },
	{ base: '모르', type: '르→ㄹ', conjugations: { past: '몰랐다', present: '모른다', polite: '몰라요' } },
	{ base: '다르', type: '르→ㄹ', conjugations: { past: '달랐다', present: '다르다', polite: '달라요' } },
	{ base: '빠르', type: '르→ㄹ', conjugations: { past: '빨랐다', present: '빠르다', polite: '빨라요' } },
	...
	{ base: '어르', type: '르→ㄹ', conjugations: { past: '얼렀다', present: '어른다', polite: '얼러요' } },
	{ base: '거두르', type: '르→ㄹ', conjugations: { past: '거둘렀다', present: '거두른다', polite: '거둘러요' } },
	{ base: '기르', type: '르→ㄹ', conjugations: { past: '길렀다', present: '기른다', polite: '길러요' } },
	{ base: '두르', type: '르→ㄹ', conjugations: { past: '둘렀다', present: '두른다', polite: '둘러요' } },
	...
	{ base: '바쁘', type: 'ㅡ탈락', conjugations: { past: '바빴다', present: '바쁘다', polite: '바빠요' } },
	{ base: '기쁘', type: 'ㅡ탈락', conjugations: { past: '기뻤다', present: '기쁘다', polite: '기뻐요' } },
	{ base: '슬프', type: 'ㅡ탈락', conjugations: { past: '슬펐다', present: '슬프다', polite: '슬퍼요' } },
	{ base: '아프', type: 'ㅡ탈락', conjugations: { past: '아팠다', present: '아프다', polite: '아파요' } },
	{ base: '고프', type: 'ㅡ탈락', conjugations: { past: '고팠다', present: '고프다', polite: '고파요' } },
	{ base: '예쁘', type: 'ㅡ탈락', conjugations: { past: '예뻤다', present: '예쁘다', polite: '예뻐요' } },
	{ base: '크', type: 'ㅡ탈락', conjugations: { past: '컸다', present: '크다', polite: '커요' } },
	{ base: '쓰', type: 'ㅡ탈락', conjugations: { past: '썼다', present: '쓴다', polite: '써요' } },
	{ base: '끄', type: 'ㅡ탈락', conjugations: { past: '껐다', present: '끈다', polite: '꺼요' } },
	{ base: '뜨', type: 'ㅡ탈락', conjugations: { past: '떴다', present: '뜬다', polite: '떠요' } },
	...
	{ base: '배우', type: '우불규칙', conjugations: { past: '배웠다', present: '배운다', polite: '배워요' } },
	{ base: '가르치', type: '우불규칙', conjugations: { past: '가르쳤다', present: '가르친다', polite: '가르쳐요' } },
	{ base: '푸', type: '우불규칙', conjugations: { past: '퍼다', present: '푼다', polite: '퍼요' } },
	{ base: '주', type: '우불규칙', conjugations: { past: '줬다', present: '준다', polite: '줘요' } },
	{ base: '배우', type: '우불규칙', conjugations: { past: '배웠다', present: '배운다', polite: '배워요' } },
	{ base: '가르치', type: '우불규칙', conjugations: { past: '가르쳤다', present: '가르친다', polite: '가르쳐요' } },

...
export const koToEnPatterns: PatternEntry[] = [
  ...
  // === 부정 패턴 (V-지 않다/못하다) ===
  { ko: /^(.+)을 (.+)지 않는다$/, en: "I don't $2 $1" },
  { ko: /^(.+)를 (.+)지 않는다$/, en: "I don't $2 $1" },
  { ko: /^(.+)지 않는다$/, en: "I don't $1" },
  { ko: /^(.+)지 않아요$/, en: "I don't $1" },
  { ko: /^(.+)지 않아$/, en: "I don't $1" },
  { ko: /^(.+)지 않았다$/, en: "I didn't $1" },
  { ko: /^(.+)지 않았어요$/, en: "I didn't $1" },
  { ko: /^(.+)지 못한다$/, en: "I can't $1" },
  { ko: /^(.+)지 못해요$/, en: "I can't $1" },
  { ko: /^(.+)지 못했다$/, en: "I couldn't $1" },
  { ko: /^(.+)지 못했어요$/, en: "I couldn't $1" },
  // 안 V 형태
  { ko: /^(.+)을 안 (.+)$/, en: "I don't $2 $1" },
  { ko: /^(.+)를 안 (.+)$/, en: "I don't $2 $1" },
  { ko: /^안 (.+)$/, en: "I don't $1" },
];

...
export const meta: MetaFunction = () => [
  ...
  { name: 'description', content: '무료 음악 도구 - 메트로놈, 드럼 머신, QR 생성기' },
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="text-center max-w-2xl">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
          <ToolCard href="/ko/metronome" title={t.tools.metronome} />
          <ToolCard href="/ko/drumMachine" title={t.tools.drumMachine} />
          <ToolCard href="/ko/qr" title={t.tools.qrGenerator} />
          <ToolCard href="/ko/translator" title={t.tools.translator} />
        </div>
      </div>
    </div>
  );

...
export const meta: MetaFunction = () => [
  ...
  {
    name: 'description',
    content: 'Free tools for musicians. No signup. No tracking. Just use.',
  },
];

const tools = [
  { icon: '⏱️', name: 'tools_metronome', href: '/metronome' },
  { icon: '🥁', name: 'tools_drumMachine', href: '/drum-machine' },
  { icon: '📱', name: 'tools_qrGenerator', href: '/qr' },
  { icon: '🌐', name: 'tools_translator', href: '/translator' },
] as const;

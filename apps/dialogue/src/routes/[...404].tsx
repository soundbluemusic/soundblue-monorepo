  ...
  return (
    <>
      ...
      <main class="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-bg-primary">
        <p class="text-[6rem] font-bold text-text-muted leading-none mb-4">
          {t.app.notFoundCode}
        </p>
        <h1 class="text-2xl font-semibold text-text-primary mb-4">
          {t.app.notFoundTitle}
        </h1>
        <p class="text-base text-text-secondary mb-8 max-w-[400px]">
          {t.app.notFoundMessage}
        </p>
        <A
          href="/"

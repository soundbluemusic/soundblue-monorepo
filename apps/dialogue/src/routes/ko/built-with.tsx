...
export const Route = createFileRoute('/ko/built-with')({
  head: () => ({
    meta: [
      { title: '오픈소스 라이센스 | Dialogue' },
      { name: 'description', content: 'Dialogue를 만드는 데 사용된 오픈소스 라이브러리' },
      // Open Graph
      { property: 'og:title', content: '오픈소스 라이센스 | Dialogue' },
      {
        property: 'og:description',
        content: 'Dialogue를 만드는 데 사용된 오픈소스 라이브러리',
      },
      { property: 'og:url', content: 'https://dialogue.soundbluemusic.com/ko/built-with' },

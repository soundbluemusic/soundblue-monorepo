    ...
    <div className="min-h-full flex flex-col bg-[var(--color-bg-primary)]">
      ...
      <main className="flex-1 py-6 px-8 max-md:py-6 max-md:px-4 max-w-[800px] mx-auto w-full">
        ...
        <div className="text-center py-8 max-md:py-6">
          ...
          <p className="text-sm text-[var(--color-text-tertiary)] mb-2">{m['app.version']()}</p>
          <p className="text-base text-[var(--color-text-secondary)]">{m['app.subtitle']()}</p>
        </div>

        {/* Features Section */}
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-6 pb-2 border-b border-[var(--color-border-primary)]">
            {m['app.aboutFeatures']()}
          </h2>
          <div className="grid grid-cols-2 max-md:grid-cols-1 gap-4">
            <div className="p-6 bg-[var(--color-bg-secondary)] border border-[var(--color-border-primary)] rounded-lg">
              <div className="inline-flex items-center justify-center w-11 h-11 bg-blue-500/10 text-[var(--color-accent-primary)] rounded-lg mb-4">
                <OfflineIcon />
              </div>
              <h3 className="text-[0.9375rem] font-semibold text-[var(--color-text-primary)] mb-1">
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center py-3.5 px-[18px] bg-[var(--color-bg-secondary)] border border-[var(--color-border-primary)] rounded-lg">
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-col gap-2">
            <a
              ...
              className="flex items-center gap-4 py-3.5 px-[18px] bg-[var(--color-bg-secondary)] border border-[var(--color-border-primary)] rounded-lg text-[var(--color-text-primary)] no-underline transition-colors duration-150 hover:bg-blue-500/5 focus:outline-2 focus:outline-[var(--color-border-focus)] focus:outline-offset-2"
            >
              <GithubIcon />

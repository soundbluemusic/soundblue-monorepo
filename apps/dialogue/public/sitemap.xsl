...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="sitemap:sitemapindex">
    <html>
      <head>
        <title>Sitemap Index - Dialogue</title>
      ...
      <body>
        <div class="container">
          <header>
            <h1>Sitemap Index</h1>
            <p class="subtitle">
              XML Sitemap for <a href="https://dialogue.soundbluemusic.com">Dialogue</a>
            </p>
          </header>
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="info">
            This sitemap contains <strong><xsl:value-of select="count(sitemap:url)"/></strong> URL(s) with multilingual support (English, Korean &amp; Japanese).
            Learn more at <a href="https://sitemaps.org" target="_blank" rel="noopener">sitemaps.org</a>.
          </div>

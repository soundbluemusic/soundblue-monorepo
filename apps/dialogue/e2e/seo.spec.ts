...
/**
 * Dialogue App - SEO Meta Tags Tests
 *
 * 검증 항목:
...
test.describe('SEO Meta Tags', () => {
  test('home page should have proper meta tags', async ({ page }) => {
    ...
    await expect(canonical).toHaveAttribute('href', /dialogue\.soundbluemusic\.com/);
  ...
  test('should have hreflang alternate links', async ({ page }) => {
    ...
    await expect(enLink).toHaveAttribute('href', /dialogue\.soundbluemusic\.com/);
...
test.describe('SEO Content Structure', () => {
  ...
  test('pages should have descriptive titles', async ({ page }) => {
    const pageTests = [{ path: '/about', expected: /About|소개/ }];
